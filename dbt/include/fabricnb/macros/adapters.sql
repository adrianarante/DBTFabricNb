...
{% macro fabricnb__alter_column_type(relation,column_name,new_column_type) -%}
...
{% macro fabricnb__check_schema_exists(information_schema,schema) -%}
...
{% macro fabricnb__create_schema(relation) -%}
...
{% macro fabricnb__drop_relation(relation) -%}
...
{% macro fabricnb__drop_schema(relation) -%}
...
{% macro fabricnb__get_columns_in_relation(relation) -%}
...
{% macro fabricnb__list_relations_without_caching(schema_relation) -%}
'''creates a table of relations withough using local caching.'''
{% endmacro %}

{% macro fabricnb__list_schemas(database) -%}
...
{% macro fabricnb__rename_relation(from_relation, to_relation) -%}
...
{% macro fabricnb__truncate_relation(relation) -%}
...
{% macro fabricnb__current_timestamp() -%}
